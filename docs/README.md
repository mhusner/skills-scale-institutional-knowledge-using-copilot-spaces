...
Work starts in **Initiation**, where the PM (Project Manager) and Product Lead (Product Manager/PdM) align on business need, stakeholders/sponsors, measurable success metrics, risks, and a high-level timeline in a one-pager. A project moves to planning when outcomes are clear, priority is aligned, and team capacity is confirmed.
