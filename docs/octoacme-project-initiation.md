...
- Role assignments captured using [Role Alignment Checklist](./octoacme-role-alignment-checklist.md)
...
- [ ] Role owners and handoffs confirmed via [Role Alignment Checklist](./octoacme-role-alignment-checklist.md)
